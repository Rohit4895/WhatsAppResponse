...
import com.example.whatsappresponse.service.utils.DataBaseClient;
import com.example.whatsappresponse.service.utils.DataBaseCrudOperations;
...
public class MainActivityViewModel extends AndroidViewModel implements
    ...
    public LiveData<List<MessageResponse>> getList(){
        new DataBaseCrudOperations(getApplication()).getMessagesList(this);
        return messageList;
    }

    public LiveData<Boolean> deleteMessage(int messageId){
        new DataBaseCrudOperations(getApplication()).delete(this,messageId);
